...
const theme = {
  ...
  const languages = [
    ...
    {
      name: 'Thanks for the time, hpe you are satisfied with out servive',
      year: '#BYE'
    },
    {
      name: 'CSS : 2000$, Phone : 100$',
      year: '#PRI'
    }
  ];
  ...
  function getSuggestions(value) {
    ...
    return languages.filter(language => regex.test(language.year));
  }
                                ...
                                header={
                                    <div className="flex flex-col justify-between flex-1 px-2 pt-4">
                                        <div className="flex items-start">
                                            ...
                                            <Icon onClick={()=>handleCloseChat(chatArray[0].id)}>close</Icon>
                                        </div>
                                    </div>
                                }
                                content={
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div className="bubble flex relative items-center justify-center p-4 max-w-full">
                                                                                ...
                                                                                {/* <Typography className="time absolute  w-full text-11 mt-8 -mb-24 left-0 bottom-0 whitespace-no-wrap"
                                                                                    color="textSecondary">{moment(item.time).format('h:mm:ss a')}</Typography> */}
                                                                            </div>
                                                                        </div>
                                                                    )
                                                                })}
                                ...
                                header={
                                    <div className="flex flex-col justify-between flex-1 px-2 pt-4">
                                        <div className="flex items-start">
                                            ...
                                            <Icon onClick={()=>handleCloseChat(chatArray[index].id)}>close</Icon>
                                        </div>
                                    </div>
                                }
                                content={
