...
export default function AgentChat(props) {
  ...
  return (
    <div className="flex flex-row flex-wrap " style={{width: "100%", height: "100%"}}>
        <div className="p-5 w-full" style={{height: "10%"}}>
        ...
        />
                    {/* <div className=" flex w-full items-center  px-16 py-16 border-b-1" style={{width: "75%"}}>
                        <div className="items-center justify-between" style={{width: "10%"}}>
                            <Emojify>:wink:</Emojify>
                        </div>
                        <div className="items-center justify-between" style={{width: "30%"}}>
                            <Typography className="text-16 ">{chatArray[0].name}</Typography>
                        </div>
                        <div className="items-center justify-between" style={{width: "30%"}}>
                            <div >mood</div>
                        </div>
                    ...
                    <div className="col flex flex-row flex-wrap w-full" style={{width: "75%"}}>
                        <div className="w-full md:w-1/2 p-8 min-h-420 h-420" style={{width: "75%"}}>
                        <form className="absolute bottom-0 right-0 left-0 py-16 px-8" style={{width: "74%", left: "10px"}}>
                    <Paper className="flex items-center relative rounded-24" elevation={1}>
                        <TextField
                            autoFocus={false}
                            id="message-input"
